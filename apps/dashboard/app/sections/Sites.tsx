    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 pt-12 pb-16">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-4">
          ...
          <MetricBox title="Pilot Sites" value={infrastructure.pilot_sites} />

          <MetricBox title="Installed Capacity" value={`${totalCapacity} kW`} />

          <MetricBox title="Energy Storage" value={`${totalStorage} kWh`} />
            ...
            <table className="w-full border-collapse">
              ...
              <thead>
                ...
                <tr className="border-b text-left text-sm text-gray-500">
                  ...
                  <th className="py-3">Market Segment</th>
                  <th className="py-3">Capacity</th>
                  <th className="py-3">Storage</th>
                  <th className="py-3">Location</th>
                  <th className="py-3">Deployment Status</th>
              ...
              <tbody>
                ...
                {sites.map((site)=>(
                  ...
                  <tr key={site.id} className="border-b">
                    ...
                    <td>{site.customer_type}</td>

                    <td>{site.system_size_kw} kW</td>

                    <td>{site.battery_capacity_kwh} kWh</td>
...
function InvestorCard_DISABLED({
  title,
  value,
  description,
}:{
  ...
  return (
    ...
    <div className="rounded-xl border bg-white p-6 shadow-sm">
      ...
      <h4 className="block text-sm leading-6 text-gray-500">
        {title}
      </h4>
